...
<Callout emoji="📚" title="Referências">
Para mais detalhes sobre a heurística gulosa implementada, clique [aqui](/code/greedy_heuristic).
</Callout>
...
<Callout emoji="📚" title="Referências">
Para mais detalhes sobre a implementação da aleatorização clique [aqui](/code/randomness).
</Callout>
