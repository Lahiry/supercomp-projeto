...
O código para gerar os inputs que foram utilizados no projeto se encontra abaixo:
...
Para saber como utilizar o gerador de input acima, dê uma olhadinha [aqui](/project_structure)
</Callout>